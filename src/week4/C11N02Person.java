...
class Employee extends C11N02Person {
    ...
    public Employee(String office, double salary, LocalDate hireDate, String name,
    ...
    @Override
    public String toString() {
        return "Employee{" + "office=" + office + ", salary=" + salary + ", hireDate=" + hireDate + '}';
    }
}
...
class Faculty extends Employee {
    ...
    public Faculty(String officeHours, String rank, String office, double salary,
            LocalDate hireDate, String name, String address, String phone, String email) {
...
class Staff extends Employee {
    ...
    public Staff(String jobTitle, String office, double salary, LocalDate hireDate,
